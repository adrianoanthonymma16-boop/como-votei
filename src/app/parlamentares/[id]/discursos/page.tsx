...
export default async function DiscursosPage({ params }: PageProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      <ParlamentarHeader parlamentar={parlamentar} activeTab="discursos" presenca={presenca} />
      <DiscursosTab parlamentarId={parlamentar.id} casa={parlamentar.casa as "CAMARA" | "SENADO"} />
    </div>
  );
}

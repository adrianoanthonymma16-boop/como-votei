...
const REGRAS: TemaRegra[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      'cvm', 'b3', 'bolsa', 'ação', 'ação', 'investimento', 'investimento',
  ...
  },
  {
    nome: 'meio ambiente',
    keywords: [
      'meio ambiente', 'ambiental', 'ambient', 'desmatamento', 'desmatamento',
      'amazônia', 'amazonia', 'floresta', 'biodiversidade', 'bioma',
      'sustentá', 'sustenta', 'sustentabilidade', 'reciclagem', 'reciclagem',
      ...
      'resíduo', 'residuo', 'lixo', 'aproveitamento', 'crédito', 'credito',
  ...
  },
  {
    ...
    keywords: [
      ...
      'previdência', 'previdencia', 'inss', 'aposentadoria', 'aposentadoria',
  ...
  },
  {
    ...
    keywords: [
      ...
      ' vale-transporte', 'vale refeição', 'vale.refeição', 'vale.refeicao',
      'seguro desemprego', 'abono salarial', 'pis/pasep', 'pis',
      'terceirização', 'terceirizacao', 'intermitente', 'MEI',
      'microempreendedor', 'microempreendedor', 'autônomo', 'autonomo',
  ...
  },
  {
    ...
    keywords: [
      ...
      'saneamento', 'água', 'agua', 'esgoto', 'drenagem', 'urbanismo',
      'urbanístico', 'urbânico', 'urbânico', 'habitação', 'habitacao',
      'construção civil', 'construcao civil', 'licitação', 'licitacao',
      'concessão', 'concessao', 'parceria público-privada', 'ppp',
      'rodovia', 'br-', 'ferrovia', 'transposição', 'transposicao',
  ...
  },
  {
    ...
    keywords: [
      ...
      'seguranca da informacao', 'dados pessoais', 'dados pessoais',
      ...
      'inteligencia artificial', 'blockchain', 'criptomoeda', 'criptomoeda',
